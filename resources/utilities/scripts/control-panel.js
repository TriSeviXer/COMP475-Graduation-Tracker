...
function displayMajor(user_id){
    ...
    xmlhttp.onreadystatechange = function ()
    {
        ...
        {
            // add the received html to the results element
            document.getElementById( 'major' ).innerHTML = xmlhttp.responseText;
        }
    }
    ...
    //      in the content of the HTTP packet. this makes it harder to
    //      snoop stuff and when using https, the contents are encrypted.
    xmlhttp.open( "POST", "../../resources/utilities/includes/control-panel-display-major.inc.php", true );
    ...
    var Argument =  "user_id=" + user_id;

    // send the request to the server
    xmlhttp.send(  Argument );
}

function deleteMajor(user_id){
    ...
    //      in the content of the HTTP packet. this makes it harder to
    //      snoop stuff and when using https, the contents are encrypted.
    xmlhttp.open( "POST", "../../resources/utilities/includes/control-panel-delete-major.inc.php", true );
