...
function displayScheduledCourses(courseID){
    ...
    xmlhttp.onreadystatechange = function ()
    {
        ...
        {
            // add the received html to the results element
            document.getElementById( 'myScheduleCourses' ).innerHTML = xmlhttp.responseText;
        }
    }
    ...
    //      in the content of the HTTP packet. this makes it harder to
    //      snoop stuff and when using https, the contents are encrypted.
    xmlhttp.open( "POST", "../../resources/utilities/includes/course-selection-my-schedule.inc.php", true );
    ...
    var Argument =  "class_id=" + courseID
                     + "&semester_id=" + document.getElementById( 'semester_id' ).innerHTML;

    // send the request to the server
    xmlhttp.send(  Argument );
}

function removeScheduledCourse(class_id, semester_id){
    ...
    //      in the content of the HTTP packet. this makes it harder to
    //      snoop stuff and when using https, the contents are encrypted.
    xmlhttp.open( "POST", "../../resources/utilities/includes/course-selection-my-schedule-delete.inc.php", true );
    ...
    var Argument =  "class_id=" + class_id
